...
import {View, Text, Dimensions, TouchableOpacity, FlatList, NativeModules, Image} from 'react-native';
          ...
          <View
            style={{
              ...
              {item.image ?
               ...
               <Image source={{uri: item.image}} resizeMode="stretch" style={{borderRadius: height * 0.05, width: width * 0.25, height: width * 0.25}}/>
             </View>
